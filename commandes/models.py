...
class Commande(models.Model):
    ...
    class Meta:
        ordering = ['-created_at']
        indexes = [
            # Most-used dashboard query: filter by statut
            models.Index(fields=['statut', 'created_at'], name='idx_commande_statut_date'),
            # Prevendeur sees only their own
            models.Index(fields=['prevendeur', 'statut'], name='idx_commande_prev_statut'),
            # Livreur sees only theirs
            models.Index(fields=['livreur', 'statut'], name='idx_commande_livr_statut'),
        ]
