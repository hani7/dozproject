...
const translations: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    'nav.bon_commande':'Bon de Commande','nav.statistiques':'Statistiques','nav.tournee':'Tournée',
    'nav.home':'Accueil','nav.account':'Mon Compte',
  ...
  ar: {
    ...
    'nav.bon_commande':'أمر الشراء','nav.statistiques':'الإحصائيات','nav.tournee':'الجولة',
    'nav.home':'الرئيسية','nav.account':'حسابي',
