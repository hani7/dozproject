...
const translations: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    'nav.bon_commande':'Bon de Commande','nav.statistiques':'Bénéfices','nav.tournee':'Tournée',
  ...
  ar: {
    ...
    'nav.bon_commande':'أمر الشراء','nav.statistiques':'الأرباح','nav.tournee':'الجولة',
